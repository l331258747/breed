...
import com.play.breed.adapter.breed.BreedSellAdapter;
...
public class BreedSellActivity extends BaseActivity {

    SwipeRefreshLayout swipe;

    private RecyclerView recyclerView;

    private BreedSellAdapter mAdapter;

    List<BreedSellBean> list;
    ...
    private void getList(int page) {
        List<BreedSellBean> data = new ArrayList<>();
        for (int i=0;i<10;i++){
            BreedSellBean item = new BreedSellBean();
            data.add(item);
        }
    ...
    private void initRecycler() {
        ...
        mAdapter = new BreedSellAdapter(activity, new ArrayList<>());
