...
import com.play.breed.adapter.mall.MallOrderListAdapter;
...
import com.play.breed.view.order.OrderDetailActivity;
...
public class MallOrderListFragment extends BaseFragment {
    ...
    private void getList(int page) {
        List<MallOrderListBean> data = new ArrayList<>();
        for (int i=0;i<10;i++){
            MallOrderListBean item = new MallOrderListBean();
            data.add(item);
        }
    ...
    private void initRecycler() {
        ...
        mAdapter = new MallOrderListAdapter(activity, new ArrayList<>());
        ...
        mAdapter.setOnItemClickListener(new MallOrderListAdapter.OnItemClickListener() {
            @Override
