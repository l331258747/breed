...
import com.play.breed.adapter.mall.MallGoodsCommentAdapter;
...
import com.play.breed.view.notice.NoticeDetailActivity;
...
public class MallGoodsCommentActivity extends BaseActivity {
    ...
    List<MallGoodsCommentBean> list;
    ...
    public int getLayoutId() {
        return R.layout.activity_mall_goods_comment;
    }
    ...
    private void getList(int page) {
        List<MallGoodsCommentBean> data = new ArrayList<>();
        for (int i=0;i<10;i++){
            MallGoodsCommentBean item = new MallGoodsCommentBean();
            data.add(item);
        }
    ...
    private void initRecycler() {
        ...
        mAdapter = new MallGoodsCommentAdapter(activity, new ArrayList<>());
