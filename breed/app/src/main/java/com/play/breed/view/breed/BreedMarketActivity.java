...
public class BreedMarketActivity extends BaseActivity {
    ...
    private MyBreedAdapter mAdapter;

    List<MyBreedBean> list;
    ...
    private void getList(int page) {
        List<MyBreedBean> data = new ArrayList<>();
        for (int i=0;i<10;i++){
            MyBreedBean item = new MyBreedBean();
            data.add(item);
        }
    ...
    private void initRecycler() {
        ...
        mAdapter = new MyBreedAdapter(activity, new ArrayList<>());
